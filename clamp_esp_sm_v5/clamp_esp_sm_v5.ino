...
//status:  0:device strarting up 10:off successful, 11:on successful, 12: unclamp success, 13:calibration successful  14:clamp success 15:motion completed 0-9:curresponding errors. 110:failsafe entered
//for CAN bus
...
void startupRoutine() {
  ...
  microCalibrateRotor();
  Serial.println("Switching to initial state 0: OFF");
  state = 0;
  Serial.println("Handing over to the main loop..");
  return;
}
